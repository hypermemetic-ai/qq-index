...
- **Session-history design evidence:** [`docs/session-history-indexing.md`](docs/session-history-indexing.md) records the proposed Turso engine decision and policy-neutral mature-SQLite service contract. [`benchmarks/session_history_fts5.py`](benchmarks/session_history_fts5.py) is generated-data-only and is not a production engine.
